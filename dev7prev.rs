...
async fn main() {
    if Path::new("./config.toml").exists() {
        ...
        match config {
            ...
            Err(err) => {
                println!("{} {} {} {} {}.", Color::Red.paint("[ERR]:"), Color::Fixed(7).paint("The TOML config file has either been"), Color::Red.paint("incorrectly modified"), Color::Fixed(7).paint("or"), Color::Red.paint("had a section removed"));
